...
docker run --name rtb-exchange -d -p 8085:8081 --network=rtb-ci-network ci.bw-sw.com:5000/rtb-dev-team/rtb-exchange:$1 -Dconfig.resource=application.$2.conf -jar rtb-exchange.jar
