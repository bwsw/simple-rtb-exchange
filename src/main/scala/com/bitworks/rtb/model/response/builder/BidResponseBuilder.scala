...
object BidResponseBuilder{
  protected class BidResponseBuilder(id: String, seatbid: Seq[SeatBid]){
  ...
  /** Returns builder for BidResponse */
  def builder(id: String, seatbid: Seq[SeatBid]) = new BidResponseBuilder(id, seatbid)
}
