...
/**
  * A bid object related to a specific impression in the bid request.
  *
  * @param id      bidder generated bid ID to assist with logging/tracking
  * @param impId   ID of the [[com.bitworks.rtb.model.request.Imp Imp]] object in the related bid
  *                request
  ...
  * @param bundle  bundle or package name of the app being advertised, if applicable; intended to
  ...
  * @param cid     campaign ID to assist with ad quality checking; the collection of creatives
  ...
  * @param dealId  reference to the deal.id from the bid request if this bid pertains to a
